...
export const getLevel2Lessons = (t: (key: string) => string): Lesson[] => {
    const part2Lessons: Lesson[] = [
        ...
        },
        {
            ...
            type: 'letterExamples',
            items: [
                { id: 1, text: t('Ear'), image: '/level2/5/ear.jpg', letter: 'أُ', highlight: 'أ', listenImage: '/level2/5/listen/3.png', readImage: '/level2/5/read/3.png' },
                ...
                { id: 3, text: t('Lion'), image: '/level2/5/lion.jpg', letter: 'أَ', highlight: 'أ', listenImage: '/level2/5/listen/1.png', readImage: '/level2/5/read/1.png' },
            ],
            distinguish: [
