...
export const getParts = (t: (key: string) => string): Part[] => {
    const part1Lessons: Lesson[] = [
        ...
        },
        {
            ...
            type: 'gallery',
            items: [
                { id: 1, image: '/2/7.jpg', text: t('Child') },
                { id: 2, image: '/2/8.jpg', text: t('Child') },
                { id: 2, image: '/2/3.jpg', text: t('Doctor') },
                { id: 2, image: '/2/4.jpg', text: t('Doctor') },
                { id: 2, image: '/2/5.jpg', text: t('Student') },
                { id: 2, image: '/2/6.jpg', text: t('Student') },
                { id: 2, image: '/2/1.jpg', text: t('Child') },
                { id: 2, image: '/2/2.jpg', text: t('Child') },
